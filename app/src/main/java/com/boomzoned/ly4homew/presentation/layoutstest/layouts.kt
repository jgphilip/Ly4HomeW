package com.boomzoned.ly4homew.presentation.layoutstest
...
fun TypeOfBoxs() {
    ...
    Box(
        ...
        Material3Card(
            backgroundColor = MaterialTheme.colorScheme.primary, elevation = 4.dp, modifier = Modifier
                .size(200.dp)
                .align(Alignment.TopStart)
        ) {}
        Material3Card(
            backgroundColor = MaterialTheme.colorScheme.primaryContainer, elevation = 4.dp, modifier = Modifier
                .size(150.dp)
                .align(Alignment.Center)
        ) {}
        Material3Card(
            backgroundColor = MaterialTheme.colorScheme.onPrimary, elevation = 4.dp, modifier = Modifier
                .size(100.dp)
